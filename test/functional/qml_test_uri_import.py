...
def run_tests():
    ...
    try:
        ...
        gui.wait_for_property("walletBadge", "noWalletLoaded", timeout_ms=10000, value=False)
        ...
        gui.wait_for_property("clipboardUriBanner", "visible", timeout_ms=5000, value=True)
        gui.click("clipboardUriPasteButton")
        gui.wait_for_property(
            "sendPaymentRequestStatusText", "text",
            timeout_ms=10000, contains="clipboard",
        )
        gui.wait_for_property(
            "sendNoteInput", "text",
            timeout_ms=5000, contains="clip-label",
        )
        gui.wait_for_property(
            "sendPaymentRequestMessageText", "text",
            timeout_ms=5000, contains="clipboard-note",
        )
        ...
        gui.wait_for_property("sendUriImportPopup", "opened", timeout_ms=5000, value=True)
        gui.set_text("sendUriImportInput", uri_manual)
        gui.click("sendUriImportApplyButton")
        gui.wait_for_property("sendUriImportPopup", "opened", timeout_ms=5000, value=False)
        gui.wait_for_property(
            "sendPaymentRequestStatusText", "text",
            timeout_ms=10000, contains="manual entry",
        )
        gui.wait_for_property(
            "sendNoteInput", "text",
            timeout_ms=5000, contains="manual-label",
        )
        ...
        gui.wait_for_property(
            "sendPaymentRequestStatusText", "text",
            timeout_ms=10000, contains="bitcoin://",
        )
        ...
        try:
            ...
            gui.wait_for_property(
                "sendPaymentRequestStatusText", "text",
                timeout_ms=10000, contains="file",
            )
            gui.wait_for_property(
                "sendNoteInput", "text",
                timeout_ms=5000, contains="file-label",
            )
        ...
        gui.wait_for_property(
            "sendPaymentRequestStatusText", "text",
            timeout_ms=10000, contains="drag and drop",
        )
        gui.wait_for_property(
            "sendNoteInput", "text",
            timeout_ms=5000, contains="drop-label",
        )
        ...
        try:
            ...
            gui.wait_for_property(
                "sendNoteInput", "text",
                timeout_ms=5000, contains="drop-file",
            )
        ...
        gui.wait_for_property(
            "sendNoteInput", "text",
            timeout_ms=5000, contains="drop-url",
        )
